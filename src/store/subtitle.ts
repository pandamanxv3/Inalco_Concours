...
export const frSubtitle: subtitleType[] = [
	...
	{
		fr: "Je me fonds dans la masse pour éviter d'être remarquée, tout en me tenant prête à bondir vers des rêves que j'ai choisis de chasser. ",
...
export const krSubtitle: subtitleType[] = [
	...
	},
	{
		...
		kr: "가진 거 다 팔아버리고 제주도 어디 숲속같은데 들어가서 사는 상상하도 하고. 사방이 지평선 수평선으로 둘러싸인 곳 같은데 있잖아.",
		arabic: "لكني أفكر أيضًا في بيع كل ما أملك للعيش في غابة، ربما على جزيرة جيجو، حيث يبدو السماء بلا نهاية.",
		startTimer: 27.7,
		endTimer: 38
	},
	{
	...
	{
		fr: "Mes parents vieillissent, et j'aimerais leur donner un petit-enfant, mais quand je pense à la Terre malade, je me rends compte que l'humanité est mortelle.",
		kr: "엄마아빠는 늙어가는데 손자 한번 안겨주고싶긴 하다가, 병들어가는 지구를 보면 그냥 인류는 필멸의 존재다,",
		arabic: "بينما يتقدم والداي في السن، أفكر أحيانًا في إهدائهما حفيدًا. لكن، مع رؤية حال الأرض المتدهورة، أدرك مدى هشاشة وجودنا.",
		startTimer: 105,
		endTimer: 114
	},
	{
		fr: "Nous sommes comme des oiseaux insouciants, ignorant les avertissements d'une tempête imminente.",
		kr: "  인간이란게, 마치 폭풍경보를 못알아듣는 탓에 근심걱정이 없는 새들같아.",
		arabic: "نحن، كبشر، كالطيور التي لا تبالي بتحذيرات العاصفة القادمة.",
		startTimer: 115.5,
		endTimer: 123
	},
	{
...
export const arabicSubtitle: subtitleType[] = [
	{
		...
		arabic: "تعلمت منذ صغري ان اعبر عن صوتي لافرض وجودي",
		startTimer: 4,
		endTimer: 10.5
	},
	{
		...
		arabic: "غالباً مااتسلل وحيدة في الشوارع الشعبية في الرباط لاستعيد اصوات وقوة الضجيج الذي كان يحييني",
		startTimer: 11.5,
		endTimer: 23.6
	},
	{
		...
		arabic: "لا اعلم كثيراً ما الذي يدفعني للمجيء إلى هنا الشمس القاحلة بعد الظهيرة التي تريح بشرتي  اوببساطة حركة الحشود المشغولة؟",
		startTimer: 25,
		endTimer: 40
	},
	{
		...
		arabic: "أصبح غير مرئية فكرة كانت تراودني  ولكن راحة اكتسبتها في النهاية",
		startTimer: 41.5,
		endTimer: 49.5
	},
	{
		...
		arabic: "لكن في أغلب الأوقات اعتقد انها جيدة كما هي",
		startTimer: 50,
		endTimer: 55.6
	},
	{
		...
		arabic: "اليس من الأفضل هكذا ؟ 	الاعتزال هو الصوت الذي اجد فيه راحتي الداخلية  غير مرئية هادئة ومقدرة",
		startTimer: 56.5,
		endTimer: 68
	},
	{
		...
		arabic: "العيش في الظل حيث لايمكن لأحد أن يعاتبني في الوجود اليس كذلك صوت نحو التقدير نحو الحب؟",
		startTimer: 69.2,
		endTimer: 80.3
	},
	{
	...
	},
	{
		...
		arabic: "ارغب في إيجاد نفسي لكن عندما يأتي وقت الكلام فصوتي يتلاشى في الرياح, بينما قلبي عاصفة رملية",
		startTimer: 85,
		endTimer: 96
	},
	{
		...
		arabic: "المشاعر التي احملها لا تتخطى شفتي ابدا ،وربما لن تتحقق أحلامي ابدا؟",
		startTimer: 97,
		endTimer: 106.7
	},
	{
		...
		arabic: "نحو اللانهاية أو ربما مجرد للصحراء ،اين ستنفتح الضخامة امامي وأستطيع تقبيل الصمت بارادتي ذائبة في احتضان لطيف من الكثبان الرملية",
		startTimer: 108,
		endTimer: 125
	},
	{
		fr: "Suis-je la seule à penser ainsi ?",
		kr: "나만 이런생각하나?",
		arabic: "هل أنا الوحيدة فقط التي تفكر بهذه الطريقة؟",
		startTimer: 128.4,
		endTimer: 138
	},
]
